...
model_name = "InceptionV3_3D_motion_cuboid_squatting_2"
...
trg_data_root = "KTH_Data_3D_motion_cuboid_w_squatting/"
...
def load_data_for_persons(root_folder, start_index, finish_index, frames_per_clip):
    ...
    class_labels = ["boxing", "handclapping", "handwaving", "jogging", "running", "squatting", "walking"] # 7 labels
...
# load training data
X_train, y_train = load_data_for_persons(trg_data_root, 1, 18, maxToAdd)
num_vids, num_frames_per_vid, _, _, _ = X_train.shape
X_train = X_train.reshape((num_vids*num_frames_per_vid,120,160,3))
print(X_train.shape)

print ("Loading val data")
X_val, y_val = load_data_for_persons(trg_data_root, 19, 20, maxToAdd)
...
X_test, y_test = load_data_for_persons(trg_data_root, 21, 25, maxToAdd)
