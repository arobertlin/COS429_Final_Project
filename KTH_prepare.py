...
#             if (recording_name.rstrip() == person_subfolder and j>20):
            if (recording_name.rstrip() == person_subfolder):
                # add indicator
                print(k)
                ...
                for p in range(0, seg_count):
                    ...
                    print(start_and_finish[0], start_and_finish[1])
                    for q in range(int(start_and_finish[0]), int(start_and_finish[1])+1):
                        # move the frames
                        if (q < 10):
                            frame_name = "frame" + str(0) + str(q) + ".jpg"
                        else:
...
missing_folder = trg_data_root + "handclapping/frames3/person13_handclapping_d3"
neighbor_folder = trg_data_root + "handclapping/frames3/person13_handclapping_d2"
