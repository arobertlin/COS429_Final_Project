...
from keras.layers import Conv2D, Dense, Conv3D, MaxPool3D
...
input_shape = (16, 120, 160, 25, 1)
x = tf.random.normal(input_shape)
model.add(Conv3D(4, 5, input_shape=input_shape[1:]))

model.add(MaxPool3D(pool_size=(2, 2, 2)))

model.add(Conv3D(16, 3, strides=(2, 2, 2), padding='same'))

model.add(MaxPool3D(pool_size=(2, 2, 2)))

model.add(Conv3D(64, 3, strides=(2, 2, 2), padding='same'))
